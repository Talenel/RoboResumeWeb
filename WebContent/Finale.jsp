...
<head>
    ...
    <!-- Global CSS -->
    <link rel="stylesheet" href="http://themes.3rdwavemedia.com/demo/orbit/assets/plugins/bootstrap/css/bootstrap.min.css">   
    <!-- Plugins CSS -->
    <link rel="stylesheet" href="http://themes.3rdwavemedia.com/demo/orbit/assets/plugins/font-awesome/css/font-awesome.css">
    
    <!-- Theme CSS -->  
    <link id="theme-style" rel="stylesheet" href="http://themes.3rdwavemedia.com/demo/orbit/assets/css/styles.css">
    
    <!-- Carbonads (demo only) -->
    <link rel="stylesheet" href="http://themes.3rdwavemedia.com/demo/orbit/demo-only/demo-ads.css">
...
<body>
    <div class="wrapper">
        <div class="sidebar-wrapper">
            <div class="profile-container">
                <img class="profile" src="http://themes.3rdwavemedia.com/demo/orbit/assets/images/profile.png" alt="" />
    ...
    <!-- Carbonads (demo only) -->
    <script type="text/javascript" src="demo-only/demo-ads.js"></script>   
</body>
</html> 